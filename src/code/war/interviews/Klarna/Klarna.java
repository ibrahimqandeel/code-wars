...
public class Klarna {
    ...
    public void test_ingredients() {
        ...
        Assert.assertEquals(output, Klarna.ingredients(input));
    }

    @Test
    public void classicSmoothie() {
        Assert.assertEquals("banana,honey,mango,peach,pineapple,strawberry",
                Klarna.ingredients("Classic"));
    }

    @Test
    public void classicSmoothieWithoutStrawberry() {
        Assert.assertEquals("banana,honey,mango,peach,pineapple",
